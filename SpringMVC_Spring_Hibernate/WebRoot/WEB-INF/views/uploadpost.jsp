...
<body>
		...
		<ul class="nav navbar-nav navbar-right">
			<c:choose>
				<c:when test="${sessionScope.user_name!=null}">
					<li><a class="llii" href="personal/personal.jsp"><span
	...
	<div class="vdo">
		...
		<div id="uploader-demo">
			...
			<div id="upInfo"></div>
			<div id="filePicker">
				<form action="uploaderr?user_id=${sessionScope.user_name.user_id}"
	...
	<div class="vdo">
		<form action="text/addtext?user_id=${sessionScope.user_name.user_id}" role="form" method="post">
			<div class="form-group">
